...
{
    /// <inheritdoc />
    public partial class ReleasedEdition : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StrategyPreference = table.Column<int>(type: "INTEGER", nullable: false),
                    State = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Colour = table.Column<string>(type: "TEXT", fixedLength: true, maxLength: 9, nullable: false, defaultValue: "#ffffffff"),
                    Accent = table.Column<string>(type: "TEXT", fixedLength: true, maxLength: 9, nullable: false, defaultValue: "#000000ff"),
                    Mark = table.Column<bool>(type: "INTEGER", nullable: false),
                    State = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DisqualificationOdds = table.Column<int>(type: "INTEGER", nullable: false),
                    FatalityOdds = table.Column<int>(type: "INTEGER", nullable: false),
                    SafetyCarOdds = table.Column<int>(type: "INTEGER", nullable: false),
                    SafetyCarReturnOdds = table.Column<int>(type: "INTEGER", nullable: false),
                    SafetyCarGap = table.Column<int>(type: "INTEGER", nullable: false),
                    SafetyCarGapCloser = table.Column<int>(type: "INTEGER", nullable: false),
                    BattleRng = table.Column<int>(type: "INTEGER", nullable: false),
                    DriverStatusPaceModifier = table.Column<int>(type: "INTEGER", nullable: false),
                    SetupRng = table.Column<int>(type: "INTEGER", nullable: false),
                    State = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Colour = table.Column<string>(type: "TEXT", fixedLength: true, maxLength: 9, nullable: false),
                    Pace = table.Column<int>(type: "INTEGER", nullable: false),
                    MinimumLife = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AfterRound = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    SetupGained = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Tyre",
                columns: new[] { "Id", "Colour", "DistanceMax", "DistanceMin", "ForWet", "MinimumLife", "Name", "Pace", "PitWhenBelow", "State", "WearMax", "WearMin" },
                values: new object[,]
                {
                    { 1L, "#fa0536ff", 125, 50, false, -25, "Soft", 200, 20, 1, 25, 15 },
                    { 2L, "#f4ea26ff", 999, 125, false, -25, "Medium", 180, 15, 1, 15, 9 },
                    { 3L, "#dfdde9ff", 999, 175, false, -25, "Hard", 160, 10, 1, 10, 6 },
                    { 4L, "#bded80ff", 999, 100, false, -25, "Grooved", 100, 0, 2, 3, 1 },
                    { 5L, "#3399ffff", 999, 50, true, -25, "Wet", 50, 0, 1, 1, 0 }
                });
