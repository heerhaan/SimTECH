...
namespace SimTECH
{
    public static class Constants
    {
        ...
        private static readonly MudColor BrightRed = new("#ff0015");

        private static readonly MudColor LightBeige = new("#ffac79");
        ...
        private static readonly MudColor UltraDarkContrastPurple = new("#100C14");
        ...
        private static readonly MudColor DarkBlack = new("#0f0f0f");
        private static readonly MudColor DeepDarkBlack = new("#070707");
        #endregion
        ...
        public static readonly MudTheme DefaultTheme = new()
        {
            ...
            PaletteDark = new PaletteDark()
            {
                ...
                Surface = DarkBlack,
                DrawerBackground = DarkBlack,
                AppbarBackground = DarkBlack,
            },
        ...
        public static readonly MudTheme GalacticAltTheme = new()
        {
            ...
            PaletteDark = new PaletteDark()
            {
                ...
                Surface = UltraDarkContrastPurple,
